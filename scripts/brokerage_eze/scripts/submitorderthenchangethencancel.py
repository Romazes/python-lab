...
class CreateSingleOrder:
    def __init__(self):
        ...
        self.symbol = 'symbol'
        self.quantity = 2000 # Quantity/Volume
        ...
        self.prc = 143.500
        self.prc_type = 0  # Market = 0, Limit = 1, StopMarket = 2, StopLimit = 3, Other = 4
        ...
        try:
            for order_info in subscribe_response:
                if order_info.OrderTag == self.my_order_id or order_info.OrderTag == self.my_chgorder_tag:
                    ...
                    if self.status == State.ChangePending.name and order_info.Type == 'UserSubmitChange':
                    ...
                    elif self.status == State.OrderPending.name and order_info.Type == 'UserSubmitOrder':
                        if order_info.CurrentStatus == 'LIVE':
                            ...
                            #Changing Limit Price
                            change_order.Price.value=121.5
                            # Changing Extented Fields as required
                            change_order.ExtendedFields['DEST_ROUTE'] = 'DEMOEUR'
